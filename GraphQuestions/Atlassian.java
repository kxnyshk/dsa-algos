...
public class Atlassian {
    ...
    // An Atlassian Graph question from my on Campus OA test.
    // Prompt: Weighted graph is given, find the smallest path
    // between the Node (1) & Node (V). While traversing you may 
    // add an extra weighted edge (of weight 1) between Nodes that 
    // aren't pre connected together according to the question. No self
    // edges allowed.
